AliAnalysisTaskAntipdh* AddMyTask(TString name = "name")
{
    ...
    fileName += ":AntipdhTask";      // create a subfolder in the file
    // now we create an instance of your task
    AliAnalysisTaskAntipdh* task = new AliAnalysisTaskAntipdh(name.Data());   
    if(!task) return 0x0;
